! function(t, e) {
    ...
    var C = function(t) {
        var e, i, n, s, o, r, a, l, h, c, u, d, p, f, g, m, v, _, y, b = "sizzle" + 1 * new Date,
            w = t.document,
            x = 0,
            C = 0,
            k = rt(),
                        ...
                        return 1 === n && 0 === s ? function(t) {
                            ...
                            function(e, i, l) {
                                ...
                                if (m) {
                                    ...
                                    } else if (_ && (y = p = (h = (c = (u = (d = e)[b] || (d[b] = {}))[d.uniqueID] || (u[d.uniqueID] = {}))[t] || [])[0] === x && h[1]), !1 === y)
                                        for (;
                                            (d = ++p && d && d[g] || (y = p = 0) || f.pop()) && ((a ? d.nodeName.toLowerCase() !== v : 1 !== d.nodeType) || !++y || (_ && ((c = (u = d[b] || (d[b] = {}))[d.uniqueID] || (u[d.uniqueID] = {}))[t] = [x, y]),
                                                d !== e));)
                                    ;
    ...
    b.fn.ready = function(t) {
        ...
        b.extend({
            ...
            readyWait: 1,
            ready: function(t) {
                (!0 === t ? --b.readyWait : b.isReady) || (b.isReady = !0, !0 !== t && --b.readyWait > 0 || R.resolveWith(n, [b]))
            }
        }),
        b.ready.then = R.then,
    ...
    b.event = {
                    ...
                    for (h = (e = (e || "").match(H) || [""]).length; h--;)
                        if (p = g = (a = bt.exec(e[h]) || [])[1],
                            ...
                            for (u = b.event.special[p] || {},
                                ...
                                r = o = d.length; o--;)
                                c = d[o], !s && g !== c.origType || i && i.guid !== c.guid || a && !a.test(c.namespace) || n && n !== c.selector && ("**" !== n || !c.selector) || (d.splice(o, 1),
            ...
            dispatch: function(t) {
                var e, i, n, s, o, r, a = b.event.fix(t),
    ...
    function jt(t, e, i) {
        ...
        return (i = i || Lt(t)) && ("" !== (r = i.getPropertyValue(e) || i[e]) || b.contains(t.ownerDocument, t) || (r = b.style(t, e)), !f.pixelBoxStyles() && zt.test(r) && Wt.test(e) && (n = a.width,
                s = a.minWidth,
                o = a.maxWidth,
    ...
    b.extend(b.event, {
            trigger: function(e, i, s, o) {
                ...
                if (a = f = l = s = s || n,
                    ...
                    for (r = 0;
                        (a = v[r++]) && !e.isPropagationStopped();)
                        f = a,
                        e.type = r > 1 ? h : p.bindType || _,
                        (d = (Q.get(a, "events") || {})[e.type] && Q.get(a, "handle")) && d.apply(a, i),
                        (d = c && a[c]) && d.apply && K(a) && (e.result = d.apply(a, i), !1 === e.result && e.preventDefault());
                    return e.type = _,
        ...
        b.extend({
            ...
            ajax: function(e, i) {
                "object" == typeof e && (i = e,
                        e = void 0),
                    i = i || {};
                var s, o, r, a, l, h, c, u, d, p, f = b.ajaxSetup({}, i),
                    g = f.context || f,
                ...
                for (d in (u = b.event && f.global) && 0 == b.active++ && b.event.trigger("ajaxStart"),
                    ...
                    f.hasContent ? f.data && f.processData && 0 === (f.contentType || "").indexOf("application/x-www-form-urlencoded") && (f.data = f.data.replace(Te, "+")) : (p = f.url.slice(o.length),
                        f.data && (f.processData || "string" == typeof f.data) && (o += (ye.test(o) ? "&" : "?") + f.data,
                            delete f.data), !1 === f.cache && (o = o.replace(Se, "$1"),
                            p = (ye.test(o) ? "&" : "?") + "_=" + _e++ + p),
                        f.url = o + p),
    ...
    b.ajaxSetup({
        ...
        b.offset = {
            setOffset: function(t, e, i) {
                var n, s, o, r, a, l, h = b.css(t, "position"),
                    c = b(t),
                    u = {};
...
function(t, e, i) {
    ...
    function a(t, i, n, s) {
        ...
        return (o = r("style")).type = "text/css",
            ...
            d.fake ? (d.parentNode.removeChild(d),
                w.style.overflow = h,
                w.offsetHeight) : u.parentNode.removeChild(u), !!a
    }
    ...
    var S = function() {
        ...
        return function(e, n) {
            var s;
            return !!e && (n && "string" != typeof n || (n = r(n || "div")), !(s = (e = "on" + e) in n) && t && (n.setAttribute || (n = r("div")),
                    n.setAttribute(e, ""),
...
function(t, e) {
    ...
    e(document).on(k.CLICK_DATA_API, w, function(t) {
            var i = t.target;
            if (e(i).hasClass("btn") || (i = e(i).closest(C)[0]), !i || i.hasAttribute("disabled") || i.classList.contains("disabled"))
                t.preventDefault();
            else {
            ...
            return n.toggle = function() {
                ...
                t._dataApiKeydownHandler = function(i) {
                    if ((/input|textarea/i.test(i.target.tagName) ? !(32 === i.which || 27 !== i.which && (40 !== i.which && 38 !== i.which || e(i.target).closest(ut).length)) : ot.test(i.which)) && (i.preventDefault(),
                            i.stopPropagation(), !this.disabled && !e(this).hasClass(at))) {
                ...
                i._showBackdrop = function(t) {
                    ...
                    if (this._isShown && this._config.backdrop) {
                        if (this._backdrop = document.createElement("div"),
                            ...
                            e(this._backdrop).addClass(kt), !t)
                            return;
                        if (!n)
                            return void t();
        ...
        Ee = function() {
            ...
            return i.show = function() {
                    ...
                    if (!(this._element.parentNode && this._element.parentNode.nodeType === Node.ELEMENT_NODE && e(this._element).hasClass(Te) || e(this._element).hasClass("disabled"))) {
                        ...
                        if (n && e(n).trigger(a),
                            e(this._element).trigger(h), !h.isDefaultPrevented() && !a.isDefaultPrevented()) {
    ...
    t.magnificPopup.registerModule("gallery", {
        ...
        proto: {
            initGallery: function() {
                var i = e.st.gallery,
                    s = ".mfp-gallery";
                return e.direction = !0, !(!i || !i.enabled) && (o += " mfp-gallery",
                    b(c + s, function() {
...
function(t) {
    ...
    t.cleanData = function(e) {
        ...
        t.ui.focusable = function(e, i) {
            ...
            return "area" === l ? (s = (n = e.parentNode).name, !(!e.href || !s || "map" !== n.nodeName.toLowerCase()) && ((o = t("img[usemap='#" + s + "']")).length > 0 && o.is(":visible"))) : (/^(input|select|textarea|button|object)$/.test(l) ? (r = !e.disabled) && ((a = t(e).closest("fieldset")[0]) && (r = !a.disabled)) : r = "a" === l && e.href || i,
        ...
        t.ui.plugin.add("draggable", "scroll", {
            ...
            drag: function(e, i, n) {
                ...
                r !== a && "HTML" !== r.tagName ? (s.axis && "x" === s.axis || (n.overflowOffset.top + r.offsetHeight - e.pageY < s.scrollSensitivity ? r.scrollTop = o = r.scrollTop + s.scrollSpeed : e.pageY - n.overflowOffset.top < s.scrollSensitivity && (r.scrollTop = o = r.scrollTop - s.scrollSpeed)),
                    ...
                    s.axis && "y" === s.axis || (e.pageX - t(a).scrollLeft() < s.scrollSensitivity ? o = t(a).scrollLeft(t(a).scrollLeft() - s.scrollSpeed) : t(window).width() - (e.pageX - t(a).scrollLeft()) < s.scrollSensitivity && (o = t(a).scrollLeft(t(a).scrollLeft() + s.scrollSpeed)))), !1 !== o && t.ui.ddmanager && !s.dropBehaviour && t.ui.ddmanager.prepareOffsets(n, e)
            }
        }),
    ...
    t.ui.ddmanager = {
            ...
            drop: function(e, i) {
                ...
                return t.each((t.ui.ddmanager.droppables[e.options.scope] || []).slice(), function() {
                        this.options && (!this.options.disabled && this.visible && h(e, this, this.options.tolerance, i) && (n = this._drop.call(this, i) || n), !this.options.disabled && this.visible && this.accept.call(this.element[0], e.currentItem || e.element) && (this.isout = !0,
                            this.isover = !1,
        ...
        t.widget("ui.resizable", t.ui.mouse, {
            ...
            _mouseDrag: function(e) {
                var i, n, s = this.originalMousePosition,
                    ...
                    a = e.pageY - s.top || 0,
                    l = this._change[o];
                return this._updatePrevProperties(), !!l && (i = l.apply(this, [e, r, a]),
            ...
            _mouseDrag: function(e) {
                ...
                for (this.position = this._generatePosition(e),
                    ...
                    this.options.scroll && (this.scrollParent[0] !== this.document[0] && "HTML" !== this.scrollParent[0].tagName ? (this.overflowOffset.top + this.scrollParent[0].offsetHeight - e.pageY < r.scrollSensitivity ? this.scrollParent[0].scrollTop = a = this.scrollParent[0].scrollTop + r.scrollSpeed : e.pageY - this.overflowOffset.top < r.scrollSensitivity && (this.scrollParent[0].scrollTop = a = this.scrollParent[0].scrollTop - r.scrollSpeed),
                        ...
                        e.pageX - this.document.scrollLeft() < r.scrollSensitivity ? a = this.document.scrollLeft(this.document.scrollLeft() - r.scrollSpeed) : this.window.width() - (e.pageX - this.document.scrollLeft()) < r.scrollSensitivity && (a = this.document.scrollLeft(this.document.scrollLeft() + r.scrollSpeed))), !1 !== a && t.ui.ddmanager && !r.dropBehaviour && t.ui.ddmanager.prepareOffsets(this, e)),
                    this.positionAbs = this._convertPositionTo("absolute"),
    ...
    t.widget("ui.controlgroup", {
        ...
        t.extend(e.prototype, {
            ...
            _showDatepicker: function(e) {
                ...
                ("input" !== (e = e.target || e).nodeName.toLowerCase() && (e = t("input", e.parentNode)[0]),
                    ...
                    t.datepicker._curInst && t.datepicker._curInst !== i && (t.datepicker._curInst.dpDiv.stop(!0, !0),
                        i && t.datepicker._datepickerShowing && t.datepicker._hideDatepicker(t.datepicker._curInst.input[0])), !1 !== (o = (n = t.datepicker._get(i, "beforeShow")) ? n.apply(e, [e, i]) : {}) && (s(i.settings, o),
                        i.lastVal = null,
            ...
            _generateHTML: function(t) {
                var e, i, n, s, o, r, a, l, h, c, u, d, p, f, g, m, v, _, y, b, w, x, C, k, T, D, S, E, I, A, P, O, N, M, H, z, L, W, j, R = new Date,
        ...
        t.widget("ui.tabs", {
            ...
            _setOptionDisabled: function(e) {
                ...
                for (t.isArray(e) && (e.length ? e.length === this.anchors.length && (e = !0) : e = !1),
                    s = 0; n = this.tabs[s]; s++)
                    i = t(n), !0 === e || -1 !== t.inArray(s, e) ? (i.attr("aria-disabled", "true"),
            ...
            d.style.cssText = "background-color:rgba(1,1,1,.5)",
                ...
                h.hsla.to = function(t) {
                    ...
                    return e = l === a ? 0 : n === a ? 60 * (s - o) / h + 360 : s === a ? 60 * (o - n) / h + 120 : 60 * (n - s) / h + 240,
                        i = 0 === h ? 0 : .5 >= u ? h / c : h / (2 - c), [Math.round(e) % 360, i, u, null == r ? 1 : r]
                },
                ...
                t.fn.extend({
                    effect: function() {
                        function i(e) {
                            ...
                            var r = t(this);
                            n.mode = c.shift(), !1 === t.uiBackCompat || o ? "none" === n.mode ? (r[h](),
...
.call(this),
            ...
            e.prototype.refresh = function() {
                ...
                for (var o in this.handleScroll(),
                    ...
                    for (var a in this.waypoints[o]) {
                        var l, h, c, u, d = this.waypoints[o][a],
                            p = d.options.offset,
                            f = d.triggerPoint,
                            g = 0,
                            m = null == f;
                        d.element !== d.element.window && (g = d.adapter.offset()[r.offsetProp]),
                            ...
                            u = !h && !c, !m && (h && c) ? (d.queueTrigger(r.backward),
            ...
            this.hide(),
                ...
                t(document).on("keydown.nice_select", ".nice-select", function(e) {
                    ...
                    if (32 == e.keyCode || 13 == e.keyCode)
                        return i.hasClass("open") ? n.trigger("click") : i.trigger("click"), !1;
                    if (40 == e.keyCode) {
                        if (i.hasClass("open")) {
    ...
    function(t, e, i, n) {
        ...
        s.Defaults = {
            ...
            s.Workers = [{
                ...
                filter: ["width", "items", "settings"],
                run: function(t) {
                    var e = (this.width() / this.settings.items).toFixed() - this.settings.margin,
                        i = null,
    ...
    function(t, e, i, n) {
        ...
        !!s("transition") && (t.support.transition = new String(o("transition")),
                t.support.transition.end = l.transition.end[t.support.transition]), !!s("animation") && (t.support.animation = new String(o("animation")),
